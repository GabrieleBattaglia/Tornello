    ...
    while True:
        ...
        if not player_id_to_add:
            ...
            if len(fide_matches) == 1:
                ...
                print("   0. Nessuno di questi / Inserimento manuale")
        ...
        if not player_id_to_add:
            print(f"Nessuna corrispondenza trovata. Procedi con l'inserimento manuale.")
