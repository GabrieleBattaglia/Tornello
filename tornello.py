...
# ------------------------------------------------------------------------------------
# Modifica 2: Funzione check_pairing_validity
# ------------------------------------------------------------------------------------
# Vecchia firma: def check_pairing_validity(p1, p2, torneo_players_dict):
# Nuova firma:
...
def generate_pairings_for_round(torneo):
    ...
    print(f"DEBUG: --- FINE GENERAZIONE PAIRING TURNO {round_number} (concluso) ---")
    return all_matches
