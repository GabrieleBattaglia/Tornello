...
class VisualSettingsDialog(wx.Dialog):
    ...
    def __init__(self, parent, current_settings):
        ...
        self.lang_choices = [self.LANG_NAMES.get(code, code.upper()) for code in self.lang_codes]
    ...
    def _init_ui(self):
        ...
        preview_val = f"Tornello v{__version__}\n> " + _("Sistema pronto ed accessibile.")
        ...
        hbox_vol.Add(wx.StaticText(tab_audio, label=_("Volume Master (%):")), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10)
        self.slider_vol = wx.Slider(tab_audio, value=self.settings.get("volume", 50), minValue=0, maxValue=100, style=wx.SL_HORIZONTAL | wx.SL_LABELS)
        ...
        hbox_fm.Add(wx.StaticText(tab_font, label=_("Dimensione (pt):")), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10)
        self.spin_size = wx.SpinCtrl(tab_font, min=8, max=72, initial=self.settings.get("font_size", 12))
        ...
        hbox_fd.Add(wx.StaticText(tab_font, label=_("Dimensione (pt):")), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10)
        self.spin_dialog_size = wx.SpinCtrl(tab_font, min=8, max=72, initial=self.settings.get("dialog_font_size", 12))
        ...
        grid_fg_m.Add(wx.StaticText(tab_fg, label=red_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_fg_m.Add(wx.StaticText(tab_fg, label=green_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_fg_m.Add(wx.StaticText(tab_fg, label=blue_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_fg_d.Add(wx.StaticText(tab_fg, label=red_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_tr = wx.SpinCtrl(tab_fg, min=0, max=100, initial=curr_dlg_text[0])
        self.spin_dialog_tr.Bind(wx.EVT_SPINCTRL, self.on_change)
        grid_fg_d.Add(self.spin_dialog_tr, 1, wx.EXPAND)
        
        grid_fg_d.Add(wx.StaticText(tab_fg, label=green_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_tg = wx.SpinCtrl(tab_fg, min=0, max=100, initial=curr_dlg_text[1])
        self.spin_dialog_tg.Bind(wx.EVT_SPINCTRL, self.on_change)
        grid_fg_d.Add(self.spin_dialog_tg, 1, wx.EXPAND)
        
        grid_fg_d.Add(wx.StaticText(tab_fg, label=blue_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_tb = wx.SpinCtrl(tab_fg, min=0, max=100, initial=curr_dlg_text[2])
        ...
        grid_bg_m.Add(wx.StaticText(tab_bg, label=red_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_bg_m.Add(wx.StaticText(tab_bg, label=green_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_bg_m.Add(wx.StaticText(tab_bg, label=blue_label), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_bg_d.Add(wx.StaticText(tab_bg, label=red_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_br = wx.SpinCtrl(tab_bg, min=0, max=100, initial=curr_dlg_back[0])
        self.spin_dialog_br.Bind(wx.EVT_SPINCTRL, self.on_change)
        grid_bg_d.Add(self.spin_dialog_br, 1, wx.EXPAND)
        
        grid_bg_d.Add(wx.StaticText(tab_bg, label=green_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_bg = wx.SpinCtrl(tab_bg, min=0, max=100, initial=curr_dlg_back[1])
        self.spin_dialog_bg.Bind(wx.EVT_SPINCTRL, self.on_change)
        grid_bg_d.Add(self.spin_dialog_bg, 1, wx.EXPAND)
        
        grid_bg_d.Add(wx.StaticText(tab_bg, label=blue_label), 0, wx.ALIGN_CENTER_VERTICAL)
        self.spin_dialog_bb = wx.SpinCtrl(tab_bg, min=0, max=100, initial=curr_dlg_back[2])
    ...
    def _get_current_values(self):
        ...
        return (size, dialog_size, vol,
                [tr, tg, tb], [dialog_tr, dialog_tg, dialog_tb],
                [br, bg, bb], [dialog_br, dialog_bg, dialog_bb])

    def _update_preview(self):
        (size, dialog_size, vol,
         text_rgb, dialog_text_rgb,
         back_rgb, dialog_back_rgb) = self._get_current_values()
