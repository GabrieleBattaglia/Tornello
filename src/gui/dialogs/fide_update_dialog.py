...
class FideUpdateDialog(wx.Dialog):
    ...
    def __init__(self, parent, settings):
        ...
        super().__init__(parent, title=title, size=(500, 250), style=wx.DEFAULT_DIALOG_STYLE)
    ...
    def init_ui(self):
        ...
        self.status_label = wx.StaticText(
            panel, 
            label=_("Aggiornamento del Database FIDE locale in corso...\n"
    ...
    def on_update_complete(self, success):
        ...
        if success:
            self.status_label.SetLabel(_("Database FIDE locale aggiornato con successo!"))
            wx.MessageBox(_("Database FIDE locale aggiornato con successo!"), _("Successo"), wx.ICON_INFORMATION)
            self.EndModal(wx.ID_OK)
        else:
            self.status_label.SetLabel(_("Errore durante l'aggiornamento del Database FIDE."))
            wx.MessageBox(_("Errore durante l'aggiornamento del Database FIDE. Controlla la connessione ad internet."), _("Errore"), wx.ICON_ERROR)
